        ...
        <div>
          <div className="flex items-center gap-2">
            <p className="text-lg font-semibold text-green-700 mt-2">
              Great! You've made an eco-friendly choice!
            </p>
            <LeafIcon />
          </div>
          ...
          <div className="flex items-center gap-2">
            <p className="text-sm text-green-600">
              You're helping reduce CO₂ emissions and protect the planet!
            </p>
          </div>
        </div>
      ) : (
          ...
          <div className="flex items-center gap-2">
            ...
            <p className="text-red-700 ">
              <span className="font-semibold">
                High CO₂ Emissions! Consider a greener option.
              </span>
              It might seem convenient, but it's harming the environment.{" "}
            </p>
          </div>

          <div className="flex items-center gap-2">
            <p className="text-sm text-green-600 mt-2">
              Think about the long-term impact on our planet{" "}
            </p>
            <SpinningEarthIcon />
          </div>
        </div>
