...
const renderWithProvider = (ui) => {
  return render(<TransportProvider>{ui}</TransportProvider>);
};
...
describe("RouteDetails Component", () => {
  ...
  it("switches transport mode when icon is clicked", () => {
    ...
    const seaIcon = screen.getAllByRole("button", {
      name: /select sea transport/i,
    })[0];
    ...
    const planeIcon = screen.getAllByRole("button", {
      name: /select plane transport/i,
    })[0];
