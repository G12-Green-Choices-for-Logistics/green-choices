    ...
    const fetchRoutes = async (
      ...
      try {
        const response = await fetch(
          `${VITE_APP_API_URL}find-routes/?sourceCountry=${sourceCountry}&destinationCountry=${destinationCountry}&sourceCity=${sourceCity}&destinationCity=${destinationCity}`,
        );
