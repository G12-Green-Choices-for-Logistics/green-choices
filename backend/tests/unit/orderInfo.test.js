...
describe("OrderInfo Model", () => {
  ...
  describe("createOrder", () => {
    ...
    test("should throw an error if database query fails", async () => {
      ...
      await expect(orderInfoModel.createOrder(mockOrderData)).rejects.toThrow(
        "Database error",
      );
  ...
  describe("updateOrder", () => {
    ...
    test("should throw an error if database query fails", async () => {
      ...
      await expect(
        orderInfoModel.updateOrder(orderId, mockOrderData),
  ...
  describe("createOrderDetail", () => {
    ...
    test("should throw an error if database query fails", async () => {
      ...
      await expect(
        orderInfoModel.createOrderDetail(mockDetailData),
      ).rejects.toThrow("Database error");
  ...
  describe("updateOrderDetail", () => {
    ...
    test("should update an order detail successfully", async () => {
      ...
      const result = await orderInfoModel.updateOrderDetail(
        orderDetailId,
        mockDetailData,
      );
    ...
    test("should throw an error if database query fails", async () => {
      ...
      await expect(
        orderInfoModel.updateOrderDetail(orderDetailId, mockDetailData),
      ).rejects.toThrow("Database error");
