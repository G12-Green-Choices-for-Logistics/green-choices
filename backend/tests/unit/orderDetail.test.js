...
describe("Order Detail Model", () => {
  ...
  describe("createOrderDetail", () => {
    ...
    test("should create an order detail successfully", async () => {
      ...
      const result =
        await orderDetailModel.createOrderDetail(mockOrderDetailData);

      expect(db.query).toHaveBeenCalledWith(
        "CALL sp_InsertOrderDetail($1, $2, $3, $4, NULL)",
        [
          mockOrderDetailData.orderId,
          mockOrderDetailData.productId,
          mockOrderDetailData.quantity,
          mockOrderDetailData.price,
        ],
      );
    ...
    test("should throw an error if database query fails", async () => {
      ...
      await expect(
        orderDetailModel.createOrderDetail(mockOrderDetailData),
  ...
  describe("updateOrderDetail", () => {
    ...
    test("should update an order detail successfully", async () => {
      ...
      const result = await orderDetailModel.updateOrderDetail(
        orderDetailId,
        mockOrderDetailData,
      );
      ...
      expect(db.query).toHaveBeenCalledWith(
        "SELECT * FROM fn_GetOrderDetailByID($1)",
        [orderDetailId],
      );
    ...
    test("should throw an error if database query fails", async () => {
      ...
      await expect(
        orderDetailModel.updateOrderDetail(orderDetailId, mockOrderDetailData),
      ).rejects.toThrow("Database error");
  ...
  describe("getOrderDetailsByOrderID", () => {
    ...
    test("should throw an error if database query fails", async () => {
      ...
      await expect(
        orderDetailModel.getOrderDetailsByOrderID(orderId),
      ).rejects.toThrow("Database error");
  ...
  describe("getOrderDetailByID", () => {
    ...
    test("should throw an error if database query fails", async () => {
      ...
      await expect(
        orderDetailModel.getOrderDetailByID(orderDetailId),
      ).rejects.toThrow("Database error");
  ...
  describe("getOrderDetailAuditHistory", () => {
    ...
    test("should get order detail audit history successfully", async () => {
      ...
      const result =
        await orderDetailModel.getOrderDetailAuditHistory(orderDetailId);
    ...
    test("should throw an error if database query fails", async () => {
      ...
      await expect(
        orderDetailModel.getOrderDetailAuditHistory(orderDetailId),
      ).rejects.toThrow("Database error");
