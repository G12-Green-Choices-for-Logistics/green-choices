...
describe("Save Route Model", () => {
  ...
  describe("saveRoute", () => {
    ...
    test("should throw error when database operation fails", async () => {
      ...
      await expect(saveRouteModel.saveRoute(routeData)).rejects.toThrow(
        dbError,
      );
  ...
  describe("updateRoute", () => {
    ...
    test("should throw error when update operation fails", async () => {
      ...
      await expect(saveRouteModel.updateRoute(routeData)).rejects.toThrow(
        dbError,
      );
      expect(db.query).toHaveBeenCalledTimes(1);
    });
  ...
  describe("getRouteByOrderId", () => {
    test("should get routes by order ID successfully", async () => {
      ...
      expect(db.query).toHaveBeenCalledWith(
        "SELECT * FROM fn_GetRouteByOrderID($1)",
        [orderId],
      );
    ...
    test("should throw error when get operation fails", async () => {
      ...
      await expect(saveRouteModel.getRouteByOrderId(orderId)).rejects.toThrow(
        dbError,
      );
      expect(db.query).toHaveBeenCalledTimes(1);
    });
  ...
  describe("saveRouteDetails", () => {
    test("should save route details successfully", async () => {
      ...
      const result = await saveRouteModel.saveRouteDetails(
        routeSegment,
        routeId,
        lastUpdatedUserId,
        seqNo,
  ...
  describe("updateRouteDetails", () => {
    test("should update route details successfully", async () => {
      ...
      const result = await saveRouteModel.updateRouteDetails(
        routeId,
        seqNo,
        routeSegment,
        lastUpdatedUserId,
  ...
  describe("getRouteDetailsByRouteId", () => {
    ...
    test("should throw error when get operation fails", async () => {
      ...
      await expect(
        saveRouteModel.getRouteDetailsByRouteId(routeId),
      ).rejects.toThrow(dbError);
      expect(db.query).toHaveBeenCalledTimes(1);
    });
  });
  ...
  describe("saveRouteStatus", () => {
    test("should save route status successfully", async () => {
      ...
      const result = await saveRouteModel.saveRouteStatus(
        routeId,
        routeDetailId,
        statusId,
        lastUpdatedUserId,
    ...
    test("should throw error when saving route status fails", async () => {
      ...
      await expect(
        saveRouteModel.saveRouteStatus(
          routeId,
          routeDetailId,
          statusId,
          lastUpdatedUserId,
  ...
  describe("updateRouteStatus", () => {
    test("should update route status successfully", async () => {
      ...
      const result = await saveRouteModel.updateRouteStatus(
        routeStatusId,
        routeId,
        routeDetailId,
        seqNo,
    ...
    test("should throw error when updating route status fails", async () => {
      ...
      await expect(
        saveRouteModel.updateRouteStatus(
          routeStatusId,
          routeId,
          routeDetailId,
          seqNo,
  ...
  describe("getRouteStatusByRouteId", () => {
    ...
    test("should throw error when get operation fails", async () => {
      ...
      await expect(
        saveRouteModel.getRouteStatusByRouteId(routeId),
      ).rejects.toThrow(dbError);
      expect(db.query).toHaveBeenCalledTimes(1);
    });
  });
